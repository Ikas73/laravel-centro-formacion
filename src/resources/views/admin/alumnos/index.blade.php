...
@if (session('success'))
    <div class="mb-4 px-4 py-3 rounded-md relative bg-green-100 border border-green-400 text-green-800" role="alert">
        ...
        {{-- Botón para cerrar (opcional, necesita JS o Alpine para funcionar completamente) --}}
...
@if (session('error')) {{-- Para futuros mensajes de error genéricos --}}
...
{{-- El resto del contenido de la vista (KPIs, filtros, tabla...) --}}
