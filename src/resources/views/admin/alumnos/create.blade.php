        ...
        <form method="POST" action="{{ route('admin.alumnos.store') }}" class="space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('nombre') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                        ...
                        <div class="space-y-2">
                            <label for="apellido1" class="block text-sm font-medium text-gray-700">
                                Primer Apellido <span class="text-red-500">*</span>
                            </label>
                            <input type="text" name="apellido1" id="apellido1" value="{{ old('apellido1') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('apellido1') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="dni" id="dni" value="{{ old('dni') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('dni') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('email') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="sexo" id="sexo" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('sexo') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror">
                    ...
                    {{-- Fecha Nacimiento, Nacionalidad y Número Seguridad Social --}}
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('fecha_nacimiento') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nacionalidad" id="nacionalidad" value="{{ old('nacionalidad', 'Española') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('nacionalidad') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                        ...
                        <div class="space-y-2">
                            <label for="numero_seguridad_social" class="block text-sm font-medium text-gray-700">
                                Número Seguridad Social <span class="text-red-500">*</span>
                            </label>
                            <input type="text" name="numero_seguridad_social" id="numero_seguridad_social" value="{{ old('numero_seguridad_social') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('numero_seguridad_social') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label for="direccion_completa" class="block text-sm font-medium text-gray-700">
                                Dirección Completa <span class="text-red-500">*</span>
                            </label>
                            <textarea name="direccion_completa" id="direccion_completa" rows="3" required
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors resize-none @error('direccion_completa') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                                      placeholder="Calle, número, piso, puerta...">{{ old('direccion_completa') }}</textarea>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="tel" name="telefono" id="telefono" value="{{ old('telefono') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('telefono') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="codigo_postal" id="codigo_postal" value="{{ old('codigo_postal') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('codigo_postal') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                                   placeholder="28001">
                            @error('codigo_postal')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="localidad" id="localidad" value="{{ old('localidad') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('localidad') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                                   placeholder="Madrid">
                            @error('localidad')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="provincia" id="provincia" value="{{ old('provincia') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('provincia') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                                   placeholder="Madrid">
                            @error('provincia')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            <label for="nivel_formativo" class="block text-sm font-medium text-gray-700">
                                Nivel Formativo <span class="text-red-500">*</span>
                            </label>
                            <select name="nivel_formativo" id="nivel_formativo" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('nivel_formativo') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror">
                        ...
                        <div class="space-y-2">
                            <label for="situacion_laboral" class="block text-sm font-medium text-gray-700">
                                Situación Laboral <span class="text-red-500">*</span>
                            </label>
                            <select name="situacion_laboral" id="situacion_laboral" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('situacion_laboral') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="estado" id="estado" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('estado') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror">
...
document.addEventListener('DOMContentLoaded', function() {
    // Validación en tiempo real para DNI/NIE
    ...
    // Formateo automático para número de seguridad social
    const nssInput = document.getElementById('numero_seguridad_social');
    if (nssInput) {
    ...
    // Formateo para código postal (solo números, máximo 5)
