...
use App\Http\Controllers\Admin\CursoController; // Necesario para la simulación de login
use App\Http\Controllers\Admin\DashboardController;                 // Necesario para la simulación de login
/*
|--------------------------------------------------------------------------
| Controladores
|--------------------------------------------------------------------------
    ...
    Route::prefix('admin') // URL base será /admin/...
        ...
        ->group(function () {
            ...
            Route::get('/reportes', function () {
                return 'Admin Reportes (Pendiente)';
            })->name('reportes.index'); // O usa ReporteController::class, 'index'
            Route::get('/finanzas', function () {
                return 'Admin Finanzas (Pendiente)';
            })->name('finanzas.index'); // O usa FinanzaController::class, 'index'
            Route::get('/configuracion', function () {
                return 'Admin Configuración (Pendiente)';
            })->name('configuracion.index'); // O usa ConfiguracionController::class, 'index'
